          ...
          <div class="contact-info">
            <div class="info-section">
              ...
              <div class="info-item">
                <div class="info-item__icon">📍</div>
                <div>
                  <span class="info-item__label">{{ 'CONTACT.INFO.LOCATION_LABEL' | translate }}</span>
              ...
              <div class="info-item">
                <div class="info-item__icon">💼</div>
                <div>
                  <span class="info-item__label">{{ 'CONTACT.INFO.AVAILABILITY' | translate }}</span>
            ...
            <div class="info-section">
              ...
              <div class="social-links">
                <a href="https://github.com/MarieSainte" target="_blank" rel="noopener" class="social-link">
                ...
                <a href="https://www.linkedin.com/in/jordan-marie-sainte-039616b1" target="_blank" rel="noopener" class="social-link">
                  <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
