    ...
    <div class="page-enter projects-page">
      <div class="container">
        ...
        <div class="filters" style="padding-top: 100px">
          ...
          <button class="filter-btn" [class.filter-btn--active]="activeFilter === 'student'"
                  (click)="setFilter('student')">
            {{ 'PROJECTS.FILTER.STUDENT' | translate }}
            <span class="filter-btn__count">{{ studentCount }}</span>
          </button>
          <button class="filter-btn" [class.filter-btn--active]="activeFilter === 'personal'"
          ...
          @for (project of filteredProjects; track project.id) {
            <div class="project-card" [style.--card-accent]="project.color">
              <div class="project-card__top">
                ...
                <span class="badge" [class.badge--accent]="project.type === 'student'"
                                    [class.badge--cyan]="project.type === 'personal'">
                  {{ (project.type === 'student' ? 'PROJECTS.CARD.STUDENT_LABEL' : 'PROJECTS.CARD.PERSONAL_LABEL') | translate }}
                </span>
              </div>
              ...
              <div class="project-card__actions">
                @if (project.github) {
                  <a [href]="project.github" target="_blank" rel="noopener" class="btn btn--ghost btn--sm" (click)="$event.stopPropagation()">
        ...
        <div class="modal-content" (click)="$event.stopPropagation()">
          ...
          <div class="modal-header">
            ...
            <div class="modal-title-group">
              <span class="badge badge--sm" [class.badge--accent]="selectedProject.type === 'student'"
                                            [class.badge--cyan]="selectedProject.type === 'personal'">
                {{ (selectedProject.type === 'student' ? 'PROJECTS.CARD.STUDENT_LABEL' : 'PROJECTS.CARD.PERSONAL_LABEL') | translate }}
              </span>
            ...
            <div class="modal-info">
              ...
              <div class="modal-links">
                @if (selectedProject.github) {
                   <a [href]="selectedProject.github" target="_blank" class="btn btn--ghost">GitHub</a>
                }
                @if (selectedProject.pptUrl) {
                   <a [href]="selectedProject.pptUrl" target="_blank" class="btn btn--outline">PowerPoint</a>
                }
              </div>
            </div>
  ...
  projects: Project[] = [
    {
      ...
      tags: ['Qwen3-1.7B', 'SFT/DPO', 'vLLM', 'DSPy', 'Docker', 'CI/CD'],
      type: 'student',
    ...
    },
    {
      ...
      tags: ['Angular', 'FastAPI', 'RAG', 'ChromaDB', 'Mistral AI', 'Docker'],
      type: 'personal',
      icon: '🌐',
      color: '#f59e0b',
    },
